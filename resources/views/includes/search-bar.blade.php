<form action="{{ route('dashboard') }}" method="GET">
    <div class='w-full max-w-[600px] flex items-center justify-center rounded-full bg-[#0d1829] px-2'>
        ...
        <input
            ...
            class="w-full bg-[#0d1829] flex bg-transparent pl-2 py-2 text-[#cccccc] outline-0 "
            placeholder="Search..."
            />  
