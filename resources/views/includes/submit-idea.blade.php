@auth
    <div class="mb-6 col-span-4 bg-gray-800 rounded-md flex items-center p-4">
        <form action="{{ route('ideas.store') }}" method="POST" class="w-full mx-auto h-full">
            ...
            <textarea name="content" id="content" rows="2" class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500" placeholder="New Idea..."></textarea>
            @error('content')
