    ...
    <div class="container  m-4">
                ...
                <div class="flex-none sm:flex">
                    ...
                    <div class="flex items-center justify-between sm:mt-2">
                        ...
                        <div class="flex flex-col">
                            ...
                            <span class="mr-3 "> {{ $user->bio }}</span><span class="mr-3 border-r border-gray-600  max-h-0"></span><span>Cochin, IND</span>
                            </div>
                        </div>
                        </div>
                    </div>
                    ...
                    <div class="flex pt-2  text-sm text-gray-400">
                        ...
                        <p class="">{{ $user->ideas()->count() }} Ideas</p>
                        </div>
                        @auth
                            @if (Auth::id() !== $user->id)
        ...
        <div class="grid grid-cols-12 gap-4 ">
            ...
            <div class="p-4 relative  bg-gray-800 border border-gray-800 shadow-lg  rounded-2xl">
                ...
                <div class="text-2xl text-gray-100 font-medium leading-8 mt-5">{{ $user->ideas()->count() }}</div>
            ...
            <div class="p-4 relative  bg-gray-800 border border-gray-800 shadow-lg  rounded-2xl">
                ...
                <div class="text-2xl text-gray-100 font-medium leading-8 mt-5">{{ $user->comments()->count() }}</div>
