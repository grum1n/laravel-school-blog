...
@section('content')
    ...
    <x-main-container class="pt-24 flex justify-center flex-col">
        <h1 class="mb-8 font-semibold text-4xl text-indigo-400 w-full text-center">
            About
        </h1>
        <x-content-box class="text-gray-200">
            <li class="relative isolate overflow-hidden bg-gray-900 py-24 sm:py-32">
                ...
                <div class="mx-auto max-w-7xl px-6 lg:px-8">
                    ...
                    <p class="mt-6 text-lg leading-8 text-gray-300">A community of students that learn and grow together.</p>
                    </div>
