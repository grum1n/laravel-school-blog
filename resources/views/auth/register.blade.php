                ...
                <div class="max-w-md w-full p-4 bg-white rounded-lg shadow-lg">
                    ...
                    <form action="" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" id="name" name="name" class="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-cyan-500">
                            @error('name')
                        ...
                        <div class="mb-4">
                            ...
                            <input type="password" id="password_confirmation" name="password_confirmation" class="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-cyan-500">
                    ...
                    <div class="text-center">
                        <p class="text-sm"><a href="#" class="text-cyan-600">Login here</a></p>
                    </div>
                </div>
              </div>
